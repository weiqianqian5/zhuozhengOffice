...
<html>
			...
			<table width="1052" border=0 align=center cellpadding=2 cellspacing=1
				...
				<tbody>
					...
					<tr align="center" bgcolor="#799AE1">
						...
						<td width="9%" align="center" class=txlHeaderBackgroundAlternate>
							竞拍次数
						</td>
						<td width="8%" align="center" class=txlHeaderBackgroundAlternate>
							游戏币价
						</td>
						...
						<td width="3%" align="center" class=txlHeaderBackgroundAlternate>
							状态
						</td>
					...
					<tr bgcolor="#DEE5FA">
						...
						<td align=center class=txlrow></td>
						<td align=center class=txlrow>
							<input type="checkbox" name="ch[1]" value="0">
						</td>
					</tr>
	...
	selectAll();;
/> </span>
							<input type="submit" name="ok" value="确定" class="but">
						</td>
					</tr>
					<tr bgcolor="#DEE5FA">
